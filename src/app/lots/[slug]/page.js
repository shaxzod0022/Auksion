    ...
    return (
      <main className="bg-gray-100 min-h-screen flex flex-col items-center justify-center p-10">
        <div className="bg-white p-12 rounded-3xl shadow-xl text-center max-w-md">
          ...
          <h1 className="text-2xl font-black text-[#18436E] mb-4 uppercase">Lot topilmadi</h1>
          <p className="text-gray-500 mb-8">Siz qidirayotgan lot o'chirilgan yoki manzili noto'g'ri kiritilgan bo'lishi mumkin.</p>
          <Link href="/lots/lots" className="bg-[#18436E] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#18436E]/90 transition-all">
      ...
      <div className="max-w-[1440px] mx-auto px-5 md:px-10 py-10">
        <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
                <span className="text-gray-400 text-xs font-bold uppercase tracking-widest">Kategoriya:</span>
                <span className="bg-white px-3 py-1 rounded-full text-[10px] font-black text-[#18436E] border border-gray-100 shadow-sm uppercase">{lot.category?.name}</span>
            </div>
        </div>
